Pulled from The Odin Project curriculum, this project aims to create a console.log-based game. The user will compete against a computer at the game rock, paper, scissors for five rounds. 
